...
class Helper{
  ...
  initDB() async {
    ...
    String path = join(databasePath, "science_notes7.db");
  ...
  Future<FutureOr<void>> onCreate(Database db, int version) async {
    ...
    sql =
        "create table VIDEO (id int PRIMARY KEY, url_image varchar(150), "
            "title varchar(50), duration varchar(5), url_video varchar(150),"
            "id_content int, constraint fk_video_id_content foreign key (id_content)"
